...
// const FlightCard = ({ flightName, flightNo, timestamp, status }) => {
//   const flightDate = moment(timestamp);
//   const today = moment();
...
//     const func = async() =>{
//         console.log("Running")
//         const flights =  await axios.post(`${BACKEND_URL}/api/user/getAllbookings`,{userId : 1})
//         const flight = flights.data.bookings.booking;
//         console.log(flight);
//         const updatedFlights = flight.filter((f) => f.status === status);
